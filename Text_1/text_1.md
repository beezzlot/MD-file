...
А можно и совсем не пользователя графическими окружениями, а полностью управлять компьютером используя командную строчку. Так, например, делают на всех серверах под управлением Linux.
