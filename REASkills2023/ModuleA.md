...
11. На сервере BR-SRV2 настройте локальный веб-сайт с содержимым
     ...
     * Аутентификация должна предусматривать доступ к ресурсу только доменных пользователей через механизм SSO. Пользователи, не являющиеся доменными, не должны иметь возможность аутентификации на ресурсе
